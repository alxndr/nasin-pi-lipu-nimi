...
const ROOTS = [
  ...
  {code: '~' , type:     'shape' , name: 'linja'  , component: <span className="spp"   ></span> },
  {code: 'ᴤ' , type:     'shape' , name: 'seme'   , component: <span className="juniko">Ƨ</span> },
  {code:'＝' , type:     'shape' , name: 'sama'   , component: <span className="spp"   ></span> },
  {code: '⊹' , type:     'shape' , name: 'weka'   , component: <span className="spp"   ></span> },
  {code: '⩍' , type:     'shape' , name: 'nena'   , component: <span className="spp"   ></span> },
  {code: '□' , type:     'shape' , name: 'leko'   , component: <span className="spp"   ></span> },
  {code: '⊿' , type:     'shape' , name: 'monsuta', component: <span className="spp"   ></span> },
  {code: '◎' , type:     'shape' , name: 'lupa'   , component: <span className="juniko">◎</span> },
  {code: '☻' , type:     'shape' , name: 'uta'    , component: <span className="spp"   ></span> },
  {code: '☞' , type:     'shape' , name: 'luka'   , component: <span className="juniko">☞</span> },
  {code: '[' , type:      'meta' , name: 'poki'   , component: <span className="spp"   ></span> },
