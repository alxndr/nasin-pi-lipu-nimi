...
const ROOTS = [
  ...
  {code: '~' , type:     'shape' , name: 'linja'  , component: <><span className="sp-ll">linja</span></> },
  {code: 'ᴤ' , type:     'shape' , name: 'seme'   , component: <><span className="juniko">Ƨ</span></> },
  {code:'＝' , type:     'shape' , name: 'sama'   , component: <><span className="sp-ll">sama</span></> },
  {code: '⊹' , type:     'shape' , name: 'weka'   , component: <><span className="sp-ll">weka</span></> },
  {code: '⩍' , type:     'shape' , name: 'nena'   , component: <><span className="sp-ll">nena</span></> },
  {code: '□' , type:     'shape' , name: 'leko'   , component: <><span className="sp-ll">leko</span></> },
  {code: '⊿' , type:     'shape' , name: 'monsuta', component: <><span className="sp-ll">monsuta</span></> },
  {code: '◎' , type:     'shape' , name: 'lupa'   , component: <><span className="juniko">◎</span></> },
  {code: '☻' , type:     'shape' , name: 'uta'    , component: <><span className="sp-ll">uta</span></> },
  {code: '☞' , type:     'shape' , name: 'luka'   , component: <><span className="juniko">☞</span></> },
  {code: '[' , type:      'meta' , name: 'poki'   , component: <><span className="sp-ll">poki</span></> },
  {code: '_' , type:      'meta' , name: 'anpa'   , component: <><span className="juniko">_</span></> },
]
